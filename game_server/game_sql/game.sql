...
CREATE TABLE `game_users`(
  ...
  `phone` VARCHAR(11) unsigned UNIQUE DEFAULT NULL COMMENT '手机号',
...
CREATE TABLE `game_articles`(
  `aid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '文章编号',
...
CREATE TABLE `game_author`(
  `pid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '作者编号',
...
CREATE TABLE `game_videos`(
  `vid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '视频编号',
...
CREATE TABLE `game_category`(
  `cid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '板块编号',
...
CREATE TABLE `game_comments`(
  `oid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
...
CREATE TABLE `game_carousel`(
  `rid` INT unsigned NOT NULL AUTO_INCREMENT COMMENT '轮播图编号',
